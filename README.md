...
해당 시스템은 bgm 볼륨만 단독으로 조절할 수 있으며,
서로 다른 지역에 존재하는 플레이어들에게 다른 bgm 사운드를 제공함
...
1. 오브젝트 시스템이 꽤 무거움
2. 오브젝트의 효과를 자유자재로 조절하기 까다로움

그래서 이를 사용하지 않고 자체적으로 구현하였음

플레이어들에게 다른 UI를 보여지게하는 까다로운 구현이 들어감 

스크립트상으로 간편하게 조절가능하게 되었으며, 효과도 자유자재로 적용 가능함
...
좋은 아이템을 만들기 확률적으로 어려우므로, 컨탠츠 소모속도 낮추기

<img width="520" height="390" alt="10" src="https://github.com/user-attachments/assets/5ab66cef-f348-4008-af11-a02684a77796" /> <br>
...
각종 UI 및, 플레이어 진행상황과 상태에 따른 개별 UI 보여주기

개개인 포탈 상태 저장 기능 존재

처음 상태는 아무 것도 없지만, 지역 진행하면서 포탈 갱신 가능
...
<img width="520" height="390" alt="14" src="https://github.com/user-attachments/assets/356df298-0449-4add-a6a0-56b87c1828e0" /> <br>

<img width="520" height="390" alt="15" src="https://github.com/user-attachments/assets/83d4633c-b100-4fb8-88d3-52f49d25f443" /> <br>

포탈 시스템 2

<img width="520" height="390" alt="16" src="https://github.com/user-attachments/assets/501394b6-03ec-4535-9e5e-71c498f9763c" /> <br>

인게임 플레이 3

<img width="520" height="390" alt="17" src="https://github.com/user-attachments/assets/0402da10-017a-4437-8aa3-7869192b3803" /> <br>
...
흔히 스탯이라고 불리우는 것들을 싹다 스크립트로 재정의 했습니다
...
스크립트 상에서 유닛의 각종 커스텀 스탯들을 조정합니다

공격력 주문력 이속 공속 치확 치피 물방 마방 체력 물리뎀감 마법뎀감 레벨 등등..

노멀 나메 헬 난이도 조정이 가능합니다

이미 완성된 컨탠츠들의 수치조정을 함으로써 재사용성을 높힙니다

그리고 또 위에 있었던 엘리트 몬스터 같은 것도 쉽게 만들 수 있습니다

<img width="745" height="483" alt="22" src="https://github.com/user-attachments/assets/5622b50f-cad6-4cfe-85a5-49e4d40f9a73" /> <br>

커스텀 스탯을 기반으로한 커스텀 데미지 시스템

유저 영웅이랑 적 몬스터들이 같은 시스템을 공유합니다

워크 기본 방어력 시스템을 안씁니다

<img width="585" height="487" alt="23" src="https://github.com/user-attachments/assets/f36c4786-8023-46ae-9ed0-8dc92c3052b9" /> <br>

이진스탯 공속시스템

위에 서술했던 커스텀 스탯 시스템과 호환되고

영웅 공속은 400% 넘어가면 기본 공속 늘리게 해서 최대 800%까지 가능하게 만들어 놨습니다

<img width="520" height="390" alt="24" src="https://github.com/user-attachments/assets/3ebdd1b8-1b0d-4d32-b8cb-689c847240d7" /> <br>

그리고 맘에 드는 템을 조합해서 내가 원하는 스탯을 몰빵해서 개성있는 플레이 가능

위 그림은 공속특화 엔드스펙이라 보면 되겠습니다

<img width="483" height="36" alt="25" src="https://github.com/user-attachments/assets/1324977c-6ebf-454f-8ea8-6dcd6e292382" /> <br>

쿨타임이랑 정지시간이 스킬 공속에 영향 받아서
...
일단 여러가지 정의해놨는데, 만든건 6번까지 만듬

AD_RESISTANCE 뭐 이런건 물리뎀감 50% 증가 방어력 20증가 이런 식임
