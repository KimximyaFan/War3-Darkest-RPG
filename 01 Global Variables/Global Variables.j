globals
    ...
    constant integer HERO = -1 /* 생성된 히어로 객체가 담김 */
    ...
    constant integer LEVEL_FLAG = 47 /* 영웅 레벨업시 스킬 집어넣는거 판별 */
    constant integer CUSTOM_UNIT_0 = 48 /* 유닛 인스턴스 종속 유닛, 그림자 mirror 혹은 마린 시즈탱크  */
    constant integer SHIELD_SYSTEM = 52 /* 유닛의 쉴드 구조체가 담김 */
