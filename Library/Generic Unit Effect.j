...
private function Dummy_Effect_Attached_Func takes nothing returns nothing
    ...
    local integer red = LoadInteger(HT, id, 8)
    local integer green = LoadInteger(HT, id, 9)
    local integer blue = LoadInteger(HT, id, 12)
    local integer transparency = LoadInteger(HT, id, 13)
    ...
    call SetUnitVertexColor(eff_dummy, red, green, blue, 255 - transparency)
